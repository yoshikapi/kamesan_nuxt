...
export default {
  ...
  */
  head: {
    ...
    script: [
      ...
      { src: '../js/bootstrap/bootstrap.min.js', type: 'text/javascript', body: true },
  ...
  */
  css: [
    ...
    `@/assets/css/font/css/open-iconic-bootstrap.css`,
    `@/assets/css/slick/slick.css`,
    `@/assets/css/slick/slick-theme.css`,
    `@/assets/css/kameCommon.css`,
    `@/assets/css/kameCommonSP.css`
  ],
  /*
